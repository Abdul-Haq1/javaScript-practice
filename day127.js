...
// meaning it only has one level, or that it does not have any other arrays nested within it. Notice it contains booleans, strings, and numbers, 
...
let yourArray = ["string", 1, true, 2, 5]; // Change this line
